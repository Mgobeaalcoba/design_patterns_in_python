...
from src.solid_principles.single_responsibility.initial_code import PaymentProcessor
...
class PaymentProcessorTests(unittest.TestCase):
    ...
    @patch('src.solid_principles.single_responsibility.initial_code.stripe.Charge.create')
    ...
    @patch('src.solid_principles.single_responsibility.initial_code.smtplib.SMTP')
    ...
    @patch('src.solid_principles.single_responsibility.initial_code.Client')
